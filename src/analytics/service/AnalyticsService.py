...
from analytics_pb2_grpc import add_AnalyticsServicer_to_server
from analytics_pb2 import DESCRIPTOR as ANALYTICS_DESCRIPTOR
from service.AnalyticsServiceservicerImpl import AnalyticsServicerImpl
...
class AnalyticsService:
    def __init__(self):
        ...
        self.servicer = AnalyticsServicerImpl()

    def install_servicers(self):
        add_AnalyticsServicer_to_server(self.servicer, self.server)
        service_names = [
